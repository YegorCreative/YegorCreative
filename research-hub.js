...
var TOOLS=[
 ...
 {id:'data',title:'Data Management',desc:'Metadata, keyword hierarchy, the 3-2-1 rule, JBOD vs RAID, and archive vs backup.',src:'research/data-management.html',tag:'Interactive',last2:true,
...
TOOLS.forEach(function(t){
 var b=document.createElement('button');b.type='button';b.className='rhub-tile'+(t.feature?' rhub-feature':'')+(t.last2?' rhub-last2':'');b.style.setProperty('--g',t.g);
